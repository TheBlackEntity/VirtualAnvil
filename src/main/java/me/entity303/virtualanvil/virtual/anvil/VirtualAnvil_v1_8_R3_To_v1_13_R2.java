...
public class VirtualAnvil_v1_8_R3_To_v1_13_R2 extends VirtualAnvil {
    ...
    public void openAnvil(Player player) {
        ...
        if (this.containerAnvilConstructor == null) try {
            this.containerAnvilConstructor = Class.forName("net.minecraft.server." + getVersion() + ".ContainerAnvil").getDeclaredConstructor(Class.forName("net.minecraft.server." + getVersion() + ".PlayerInventory"), Class.forName("net.minecraft.server." + getVersion() + ".World"), Class.forName("net.minecraft.server." + getVersion() + ".BlockPosition"), Class.forName("net.minecraft.server." + getVersion() + ".EntityHuman"));
        } catch (NoSuchMethodException | ClassNotFoundException e) {
            e.printStackTrace();
            return;
        }
        ...
        if (this.worldField == null) try {
            this.worldField = Class.forName("net.minecraft.server." + getVersion() + ".Entity").getDeclaredField("world");
        ...
        if (this.packetPlayOutOpenWindowConstructor == null) try {
            this.packetPlayOutOpenWindowConstructor = Class.forName("net.minecraft.server." + getVersion() + ".PacketPlayOutOpenWindow").getDeclaredConstructor(int.class, String.class, Class.forName("net.minecraft.server." + getVersion() + ".IChatBaseComponent"), int.class);
        } catch (NoSuchMethodException | ClassNotFoundException e) {
            e.printStackTrace();
            return;
        }
